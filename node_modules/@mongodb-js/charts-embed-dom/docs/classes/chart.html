				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#getfilter" class="tsd-kind-icon">get<wbr>Filter</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#getmaxdataage" class="tsd-kind-icon">get<wbr>Max<wbr>Data<wbr>Age</a></li>
							...
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#gettheme" class="tsd-kind-icon">get<wbr>Theme</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#isautorefresh" class="tsd-kind-icon">is<wbr>Auto<wbr>Refresh</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#refresh" class="tsd-kind-icon">refresh</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#render" class="tsd-kind-icon">render</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#setautorefresh" class="tsd-kind-icon">set<wbr>Auto<wbr>Refresh</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#setfilter" class="tsd-kind-icon">set<wbr>Filter</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#setmaxdataage" class="tsd-kind-icon">set<wbr>Max<wbr>Data<wbr>Age</a></li>
							...
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="chart.html#settheme" class="tsd-kind-icon">set<wbr>Theme</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Filter<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<p>the current filter applied to the embedded chart.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<p>the number of seconds before a chart&#39;s data expires</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<p>the current theme applied to the chart</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Triggers a refresh of the chart (if it has been embedded).</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a promise that resolves once the chart updated its data</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Renders a chart into the given <code>container</code>.</p>
							</div>
							<p>This method should only be called once, and successive attempts to call <code>render</code>
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a promise that will resolve once the chart has successfully been embedded</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">set<wbr>Filter<span class="tsd-signature-symbol">(</span>value<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Sets the filter to apply to the embedded chart.</p>
							</div>
							...
							Any fields referenced in this filter are expected to be whitelisted in the &quot;Embed Chart&quot; dialog for each Chart you wish to filter on.</p>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Set the number of seconds a chart&#39;s data expires.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Sets the color scheme to apply to the chart.</p>
							</div>
