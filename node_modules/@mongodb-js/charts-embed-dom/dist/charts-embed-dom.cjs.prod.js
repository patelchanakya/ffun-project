...
const getChartUrl = options => {
  try {
    ...
    url.search = `id=${options.chartId}&sdk=1`, options.autoRefresh ? url.search += `&autorefresh=${options.autoRefresh}` : url.search += options.refreshInterval ? `&autorefresh=${options.refreshInterval}` : "", 
